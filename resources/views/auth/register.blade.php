    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4 text-center">
                <button style="background-color: #2C710B; color: white; width: 100%; padding: 10px; border: none; border-radius: 5px; transition: background-color 0.3s;"
                        onmouseover="this.style.backgroundColor='#24560A'"
                        onmouseout="this.style.backgroundColor='#2C710B'">
                    {{ __('Registrarse') }}
                </button>
            </div>
            ...
            <div class="mt-4 text-center">
                <label class="text-xs text-gray-600">{{ __('O CONTINUAR CON') }}</label> <!-- Cambié a text-xs -->
            </div>
            ...
            <div class="mt-4 text-center">
                <button style="background-color: #E4E7EB; color: black; width: 100%; padding: 10px; border: none; border-radius: 5px; transition: background-color 0.3s;"
                        ...
                        onmouseout="this.style.backgroundColor='#E4E7EB'">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="w-5 h-5 mr-2 inline-block">
            ...
            <div class="flex items-center justify-center mt-4">
                <a style="color: red;" class="underline text-sm hover:text-red-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
